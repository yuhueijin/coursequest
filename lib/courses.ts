 ...
 *
 * 型別定義見 lib/types.ts：
 *   course.mobs   小怪們，依序打，每隻小怪先教一段 lesson 再考幾題
 *   course.boss   大魔王，通常混合這個課程教過的所有觀念
 * ============================================================
 */
    ...
    mobs: [
      {
        ...
        questions: [
          ...
          {
            q: "函式括號裡的「參數」是用來做什麼的？",
            options: ["傳入資料給函式內部使用", "宣告全域變數", "產生迴圈"],
            answer: 0,
            moveName: "參數突刺",
    ...
    boss: {
      ...
      questions: [
        ...
        },
        {
          ...
          options: ["用 for 迴圈搭配陣列索引", "只印 arr[0]", "宣告更多變數"],
          answer: 0,
          moveName: "連環突刺",
        ...
        {
          q: "函式最主要的好處是？",
          options: ["避免重複寫同樣的邏輯，方便重複使用", "讓程式變慢", "取代所有變數"],
          answer: 0,
          moveName: "呼叫擊・究極",
